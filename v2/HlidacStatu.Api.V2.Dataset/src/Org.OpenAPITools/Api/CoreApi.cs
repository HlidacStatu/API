...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class CoreApi : ICoreApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<string> localVarResponse = ApiV2PingWithHttpInfo(text);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public Org.OpenAPITools.Client.ApiResponse<string> ApiV2PingWithHttpInfo(string text, int operationIndex = 0)
        {
            // verify the required parameter 'text' is set
            if (text == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'text' when calling CoreApi->ApiV2Ping");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<string> localVarResponse = await ApiV2PingWithHttpInfoAsync(text, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<string>> ApiV2PingWithHttpInfoAsync(string text, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'text' is set
            if (text == null)
            {
